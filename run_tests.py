...
for p in problems:
    ...
    tested_items = [varistepone, korpele_basic, popov_subgrad, grad_desc]
    ...
    if statIdx > 0:
        grapher.plot(np.array(stat), xDataIndices=[0, 0, 0, 0], yDataIndices=[[2], [2], [2], [2]],
                     plotTitle=p.GetHRName(), xLabel='#iter.', yLabel='$||x_{n+1}-x_n||_L^2$',
