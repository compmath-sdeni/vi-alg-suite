...
korpele = Korpelevich(problem, eps=0.0000001, lam=0.1, min_iters=min_iters, max_iters=max_iters)
korpele_adapt = KorpelevichMod(problem, eps=0.00001, min_iters=min_iters, max_iters=max_iters)

tseng = Tseng(problem, eps=0.0000001, min_iters=min_iters, max_iters=max_iters)
tseng_adaptive = TsengAdaptive(problem, eps=0.0000001, min_iters=min_iters, max_iters=max_iters)

malitsky_tam = MalitskyTam(problem, x1=x1.copy(), eps=0.0000001, min_iters=min_iters, max_iters=max_iters)
malitsky_tam_adaptive = MalitskyTamAdaptive(problem, x1=x1.copy(), eps=0.0000001, min_iters=min_iters, max_iters=max_iters)
